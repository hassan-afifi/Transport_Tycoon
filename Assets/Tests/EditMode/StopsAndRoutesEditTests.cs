...
public class StopsAndRoutesEditTests
{
    ...
    {
        MethodInfo setSelected = typeof(CameraController).GetMethod("SetSelectedObject", BindingFlags.Instance | BindingFlags.NonPublic);
        Assert.IsNotNull(setSelected);
        setSelected.Invoke(cameraController, new object[] { selectedObject });
    }
