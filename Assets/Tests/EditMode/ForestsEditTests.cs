...
public class ForestsEditTests
{
    ...
    [Test]
    public void RebuildForestSources_RegistersForestCellsAndIgnoresNonForestBuildings()
    {
    ...
    [Test]
    public void InfectedCellAndRoadClearCostMethods_ReportAndClearAsExpected()
    {
        ForestSpreadManager manager = CreateForestManagerContext(out _, out _);
