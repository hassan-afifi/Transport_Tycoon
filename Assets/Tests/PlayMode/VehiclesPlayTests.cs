...
public class VehiclesPlayTests
{
    ...
    public void VehicleAgent_AssignStops_TracksStopAndRoadUsageAndReachability()
    {
        ...
        RegisterVehicleLoopRoads(roadNetworkManager);
        Assert.IsTrue(stopManager.TryPlaceStopAtCell(new Vector3Int(1, 0, 0)));
        Assert.IsTrue(stopManager.TryPlaceStopAtCell(new Vector3Int(3, 0, 0)));
    ...
    public void VehicleSelectedStopItemUI_SetupAndDraggingVisualUpdateProperties()
    {
        ...
        SetPrivateField(item, "labelText", null);
    ...
    public void VehicleStopAssignPanel_OpenApplyClearAndClose_UpdateVehicleAssignments()
    {
        ...
        VehicleStopAssignPanel panel = CreateVehicleStopAssignPanel(vehicleManager, stopManager, out GameObject panelRoot);
    ...
    public void VehicleStopAssignPanel_ClosePanel_RemovesVehicleWhenMinimumStopsNotMetAndRequired()
    {
        ...
        VehicleStopAssignPanel panel = CreateVehicleStopAssignPanel(vehicleManager, stopManager, out _);
        ...
        out GameObject panelRoot)
    {
        ...
        Track(new GameObject("TitleText", typeof(RectTransform))).transform.SetParent(panelRoot.transform, false);
        Track(new GameObject("AssignedText", typeof(RectTransform))).transform.SetParent(panelRoot.transform, false);
        ...
        SetPrivateField(panel, "titleText", null);
        SetPrivateField(panel, "assignedStopsText", null);
    ...
    private static void RegisterStraightNorthSouthRoad(RoadNetworkManager roadNetworkManager, Vector3Int gridCell)
    {
        bool success = roadNetworkManager.RegisterRoad(0, gridCell, 0);
        Assert.IsTrue(success);
    }

    private static void RegisterTurnRoad(RoadNetworkManager roadNetworkManager, Vector3Int gridCell, int rotationDegrees)
    {
        bool success = roadNetworkManager.RegisterRoad(1, gridCell, rotationDegrees);
        Assert.IsTrue(success);
    }

    private static void RegisterVehicleLoopRoads(RoadNetworkManager roadNetworkManager)
    {
        RegisterTurnRoad(roadNetworkManager, new Vector3Int(0, 0, 0), 90);
        RegisterStraightEastWestRoad(roadNetworkManager, new Vector3Int(1, 0, 0));
        RegisterStraightEastWestRoad(roadNetworkManager, new Vector3Int(2, 0, 0));
        RegisterStraightEastWestRoad(roadNetworkManager, new Vector3Int(3, 0, 0));
        RegisterTurnRoad(roadNetworkManager, new Vector3Int(4, 0, 0), 180);
        RegisterStraightNorthSouthRoad(roadNetworkManager, new Vector3Int(4, 0, -1));
        RegisterTurnRoad(roadNetworkManager, new Vector3Int(4, 0, -2), 270);
        RegisterStraightEastWestRoad(roadNetworkManager, new Vector3Int(3, 0, -2));
        RegisterStraightEastWestRoad(roadNetworkManager, new Vector3Int(2, 0, -2));
        RegisterStraightEastWestRoad(roadNetworkManager, new Vector3Int(1, 0, -2));
        RegisterTurnRoad(roadNetworkManager, new Vector3Int(0, 0, -2), 0);
        RegisterStraightNorthSouthRoad(roadNetworkManager, new Vector3Int(0, 0, -1));
    }
